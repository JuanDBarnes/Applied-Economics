...
export delimited using "$main/output/Holm_alphas.csv", replace // guardamos como csv los coef ajustados
...
export delimited using "$output/sharpenedqvals.csv", replace // guardamos como csv los coef ajustados
